...
TEST(CONDITIONS, Require_Not_Null) {
	std::string* nul = 0;
...
TEST(CONDITIONS, Require_Not_Null_Shared_Ptr) {
...
//TEST(CONDITIONS, Require_Not_Null_Unique_Ptr) {
...
TEST(CONDITIONS, Require_Greater_Than) {
...
TEST(CONDITIONS, Require_Less_Than) {
...
TEST(CONDITIONS, Require_Equals_To) {
...
TEST(CONDITIONS, Require_Between) {
...
TEST(CONDITIONS, Require_Not_Empty_String) {
	std::string empty = "";
...
TEST(CONDITIONS, Require_Not_Empty_Vector) {
...
TEST(CONDITIONS, Require_Not_Empty_Map) {
